...
class ScriptTest < Minitest::Test
  ...
  #
  ##################################################
  def test_script_artifact_end_to_end_success
    a = Armadillo::Script.new()
    assert !a.started? 
    assert !a.completed?
  ...
  def test_script_artifact_end_to_end_failure
    a = Armadillo::Script.new()
    assert !a.started? 
    assert !a.completed?
    assert !a.completed_successfully?
  ...
  def test_script_artifact_pre_routine_success
    @testval = "hello"
    a = Armadillo::Script.new()
  ...
  def test_script_artifact_pre_routine_failure
    @testval = "hello"
    a = Armadillo::Script.new()
    a.set_pre_routine { @testval = "goodbye" }
    assert @testval == "hello"
  ...
  def test_script_artifact_post_routine_success
    @testval = "hello"
    a = Armadillo::Script.new()
  ...
  def test_script_artifact_post_routine_failure
    @testval = "hello"
    a = Armadillo::Script.new()
    a.set_post_routine { @testval = "goodbye" }
    assert @testval == "hello"
