...
class TestcaseTest < Minitest::Test
  ...
  #
  ##################################################
  def test_testcase_artifact_end_to_end_success
    a = Armadillo::Testcase.new()
    assert !a.started? 
    assert !a.completed?
  ...
  def test_testcase_artifact_end_to_end_failure
    a = Armadillo::Testcase.new()
    assert !a.started? 
    assert !a.completed?
    assert !a.completed_successfully?
  ...
  def test_testcase_artifact_pre_routine_success
    @testval = "hello"
    a = Armadillo::Testcase.new()
  ...
  def test_testcase_artifact_pre_routine_failure
    @testval = "hello"
    a = Armadillo::Testcase.new()
    a.set_pre_routine { @testval = "goodbye" }
    assert @testval == "hello"
  ...
  def test_testcase_artifact_post_routine_success
    @testval = "hello"
    a = Armadillo::Testcase.new()
  ...
  def test_testcase_artifact_post_routine_failure
    @testval = "hello"
    a = Armadillo::Testcase.new()
    a.set_post_routine { @testval = "goodbye" }
    assert @testval == "hello"
